...
public class UserRegistrationTest {
    ...
    public void givenFirstName_WhenFirstLetterUpperCase_ShouldReturnTrue() {
        boolean output = userRegistration.validateFirstName("Pavani");
    ...
    public void givenFirstName_WhenLessThanThreeChars_ShouldReturnFalse() {
        boolean output = userRegistration.validateFirstName("Pa");
        Assert.assertEquals(false,output);
    }
    @Test
    public void givenFirstName_WhenHasNumber_ShouldReturnFalse() {
        boolean output = userRegistration.validateFirstName("Pav1");
        Assert.assertEquals(false, output);
    }
    ...
    public void givenLastName_WhenFirstLetterUpperCase_ShouldReturnTrue(){
        boolean output = userRegistration.validateLastName("Kempula");
        Assert.assertEquals(true, output);
    }
    @Test
    public void givenLastName_WhenLessThanThreeChars_ShouldReturnFalse() {
        boolean output = userRegistration.validateFirstName("Ke");
        Assert.assertEquals(false,output);

    }
    @Test
    public void givenLastName_WhenHasNumber_ShouldReturnFalse() {
        boolean output =  userRegistration.validateFirstName("Kempula1");
        Assert.assertEquals(false,output);

    }
    @Test
    public void givenLastName_WhenHasSpecialChar_ShouldReturnFalse() {
        boolean output = userRegistration.validateFirstName("Kempula@");
        Assert.assertEquals(false,output);
    ...
    public void givenPassword_WhenNoSpecialChar_ShouldReturnFalse() {
        boolean output = userRegistration.validatePassword("Pavani1ds");
        Assert.assertEquals(false,output);

    }
    @Test
    public void givenPassword_WhenHasMoreThan1SpecialChar_ShouldReturnFalse() {
        boolean output = userRegistration.validatePassword("Pavani12#@");
        Assert.assertEquals(false,output);
